...
This repo holds the [teachbook](https://design-engineering-voor-fysici.github.io/Design-Engineering-voor-Fysici-Dictaat/main/intro.html#) with all the educational material of the course "Design Engineering for Physics Students" (in Dutch: "Design Engineering voor Fysici, ie. DEF" that is taught to first year students in the physics program at Delft University of Technology.
