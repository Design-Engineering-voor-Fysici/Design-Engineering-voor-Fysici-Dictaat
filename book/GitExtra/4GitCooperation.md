...
1. Je gaat beide op je eigen laptop werken.
   ...
   - Als je tegelijk aan de opdracht wilt werken, maak dan van je opdracht branch, 2 nieuwe branches aan. Eentje voor jullie beide, zo voorkom je dat je elkaars werk kan overschrijven op github.
...
1 repo --> branch: main --> branch: elektro-opdracht1 (--> 2 branches: dev_student1 + dev_student 2)