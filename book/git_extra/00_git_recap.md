...
4. Vraag een Pull Request aan van opdracht branch naar main en laat jouw TA de reviewer zijn
   - Verbeter eventueel nog je werk met nieuwe commits en vraag weer een review aan!
5. De opdracht is goedgekeurd: 
   - Squash en merge je huidige branch met `main` en verwijder de huidige opdracht branch.
   - maak een nieuwe branch aan voor de volgende opdracht etc.
