...
1. ga naar het menu van de repo in VSCode: ![switch to branch](../figures/git/2_4_howto_switch_to_branch.png)
2. klik dan op de nieuwe `opdracht` branch: ![switch branch](../figures/git/2_5_switch_branch.png)
