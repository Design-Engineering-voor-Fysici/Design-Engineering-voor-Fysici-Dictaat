...
Dit gaan we oplossen met de opdracht eerst forken naar je eigen GitHub account.
In essentie kopiëer je dus eerst de repo naar jouw account en vandaar clone je hem naar je eigen omgeving (VScode). 

Waarom? Nu kan je samen met je groepsgenoot werken aan de opdracht en heb je een plek om je werk te delen.
